...
save_mw_cel -as ${designplace}

### Reports 

#report_placement_utilization > output/fifo_place_util.rpt
report_placement_utilization > output/${designplace}_util.rpt
report_qor_snapshot > output/${designplace}_qor_snapshot.rpt
report_qor > output/${designplace}_qor.rpt

### Timing Report

report_timing -delay max -max_paths 20 > output/${designplace}.setup.rpt
report_timing -delay min -max_paths 20 > output/${designplace}.hold.rpt
